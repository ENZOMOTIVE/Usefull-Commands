...
> Usefull Commands is a reference notebook for useful commands, snippets, and repeatable developer workflows.
...
```bash
git clone https://github.com/ENZOMOTIVE/Usefull-Commands.git
cd Usefull-Commands
```
...
| Field | Details |
| --- | --- |
| Repository | `ENZOMOTIVE/Usefull-Commands` |
| Categories | `General` |
